...
import 'package:get/get.dart'; // [추가] 화면 이동을 위해 필요
import 'package:bamtol_market_app/src/repository/contents_repository.dart';
import 'package:bamtol_market_app/src/pages/detail.dart'; // [추가] 상세 페이지 연결
          ...
          return ListView.separated(
            ...
            itemBuilder: (BuildContext context, int index) {
              ...
              return GestureDetector(
                onTap: () {
                  // 클릭 시 상세 페이지(Detail)로 이동하며 데이터 전달
